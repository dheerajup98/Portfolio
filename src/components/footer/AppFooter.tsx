            ...
            <FooterWrapper>
                <section>
                    <ul className="footer-nav-links">
                        ...
                        <li className="footer-nav-link">
                            <span>
                                <a
                                    ...
                                    href="https://www.linkedin.com/in/dheerajup98"
                                >
                                    <LinkedinFilled />
                                </a>
                            </span>
                        ...
                        <li className="footer-nav-link">
                            <span>
                                <a href="mailto:dheerajup98@gmail.com">
                                    <MailOutlined />
                                </a>
                            </span>
                        </li>
                        <li className="footer-nav-link">
                            <span>
                                <a
                                    href="https://github.com/dheerajup98"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    <GithubOutlined />
                        ...
                        <li className="footer-nav-link">
                            <span>
                                <a href="https://www.instagram.com/dheeraj_up01/" target="_blank" rel="noopener noreferrer">
                                    <InstagramOutlined />
                                </a>
                            </span>
                        </li>
